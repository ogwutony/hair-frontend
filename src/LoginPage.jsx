  ...
  return (
    <div style={styles.authContainer}>
      <div style={{ ...styles.authCard, maxWidth: '420px' }}>
        ...
        <button onClick={() => setSocialError("TikTok login is coming soon. Please use another option for now.")} style={{ ...styles.socialButton, backgroundColor: '#000', color: '#fff', border: 'none' }}>
